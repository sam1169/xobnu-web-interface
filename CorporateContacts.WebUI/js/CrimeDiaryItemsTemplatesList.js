...
function createCrimeDiaryItemsTemplateGrid(folderID, type, name) {
    $("#noRecordsMessageContainer").hide();
    var vUrl = '../ItemList';
    var vColumnHeaderNames = [
        "Subject", "Start", "End", "Location", "Lawyer Name", "Case Manager", "ID"
    ];
    jQuery(function ($) {
        ...
        jQuery(gridSelector).jqGrid({
            ...
            colModel: [
                ...
                { name: 'LawyerName', index: 'LawyerName', resize: true },
                { name: 'CaseManager', index: 'CaseManager', resize: true },
